...
extension UIImage {
    ...
    public class func p3_imageWithColor(color: UIColor) -> UIImage? {
    ...
    public class func p3_imageWithColor<C: ColorConvertible>(color: C) -> UIImage? {
        return p3_imageWithColor(color: color.color())
    }
    
    public class func p3_roundedImageWithColor(color: UIColor, size: CGSize) -> UIImage? {
    ...
    public class func p3_roundedImageWithColor<C: ColorConvertible>(color: C, size: CGSize) -> UIImage? {
        return p3_roundedImageWithColor(color: color.color(), size: size)
    }
    
    public class func p3_roundedImageWithColor(color: UIColor) -> UIImage? {
        return p3_roundedImageWithColor(color: color, size: CGSize(width: 1, height: 1))
    }
    
    public class func p3_roundedImageWithColor<C: ColorConvertible>(color: C) -> UIImage? {
        return p3_roundedImageWithColor(color: color, size: CGSize(width: 1, height: 1))
    }
}
